...
public class BeerControllerTest {
    ...
    void testPatchBeer() throws Exception {
        var testBeer = beerServiceImpl.listBeers(null, null).get(0);
    ...
    void listBeers() throws Exception {
        //
        var testListOfBeers = beerServiceImpl.listBeers(null, null);
        given(beerService.listBeers(null, null)).willReturn(testListOfBeers);
